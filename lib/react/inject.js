    ...
    return function (Component) {
        return React.forwardRef(function (props, ref) {
            ...
            var values = keys.reduce(function (keyValues, key) {
                var _a;
                return (__assign(__assign({}, keyValues), (_a = {}, _a[key] = container.get(key), _a)));
            }, {});
            return React.createElement(Component, __assign({}, props, values, { ref: ref }));
        });
    };
}; };
